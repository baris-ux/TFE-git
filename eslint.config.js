...
export default defineConfig([
    ...
    js.configs.recommended,  /* c'est un ensemble de règle préconfiguré pour JavaScript ca permet d'éviter d'écrire 100 règle à la main
	...
	{
		rules: { // pour le moemnt on va partir avec les règle par défaut spécifié par js.configs.recommended et svelte.configs['flat/recommended'] 
                // mais on peut venir ajouter nos propres règles ici
		},
	},
    {
        ignores: ['node_modules/**', 'dist/**', '.svelte-kit/**', 'src-tauri/**', 'build/**'], 
    }
]);
